 ...
 * @author ariana
 */
public class DibujoDeLineas extends JPanel {
    @Override
    ...
    public static void main(String []args){
        ...
        ventana.setSize(1365, 900); // Las coordenadas de lo lago y ancho de la ventana
        DibujoDeLineas panel= new DibujoDeLineas(); //se crea el objeto Grafica llamado panel
